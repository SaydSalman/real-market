  ...
  return (
    <>
      <main className='p-3 mx-auto'>
        <h1 className='text-center mt-5'>Update a Listing</h1>
            ...
            <div className="row">
             ...
             <div className='d-flex flex-wrap gap-3'>
              ...
              <div className="col-lg-6">
                  ...
                  <button disabled={loading || uploading} onClick={handleSubmit} className='btn btn-secondary w-75 mt-3'>{loading?"Updating":"Update Listing"}</button>
